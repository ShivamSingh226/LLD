...
public class Main {
	...
	private void runDeliveryFlow(ProductDeliverySystem productDeliverySystem, int userId) {
		...
		ProductCategory whichIwant=null;
		for(ProductCategory productCategory:inventory.productCategoryList) {
			if(productCategory.productCategoryName.equals("Peppsii Large Cold Drink")) {
				whichIwant=productCategory;
			}
		}
		productDeliverySystem.addProductToCart(user, whichIwant, 2);
